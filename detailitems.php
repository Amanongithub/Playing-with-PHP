...
<div class="row justify-content-center" style="margin-top:10px;">
	...
	<p style="color:red;display:none" id="lesserror">*could not be less then one</p>
	     ...
	     <input type="button" value="+" style="width:20%;margin:5px;" class="btn-outline-black"  onclick="update_quantityplus()">
	     <input type="button" value="-" style="width:20%;margin:5px;" class="btn-outline-black"  onclick="update_quantityminu()">
